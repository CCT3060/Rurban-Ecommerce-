      ...
      <Card>
        ...
        <CardContent className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <Field label="Attention" id="shipping_attention">
            <Input id="shipping_attention" placeholder="Attn: Warehouse" value={form.shipping_attention} onChange={(e) => { setSameAsBilling(false); set("shipping_attention")(e); }} />
          </Field>
          <Field label="Shipping Phone" id="shipping_phone">
            <Input id="shipping_phone" placeholder="+91 98765 43210" value={form.shipping_phone} onChange={(e) => { setSameAsBilling(false); set("shipping_phone")(e); }} />
          </Field>
          <div className="sm:col-span-2">
            <Field label="Address (Street 1)" id="shipping_address">
              <Input id="shipping_address" placeholder="Building, Street name" value={form.shipping_address} onChange={(e) => { setSameAsBilling(false); set("shipping_address")(e); }} />
            </Field>
          </div>
          <div className="sm:col-span-2">
            <Field label="Address (Street 2)" id="shipping_street2">
              <Input id="shipping_street2" placeholder="Locality, Landmark" value={form.shipping_street2} onChange={(e) => { setSameAsBilling(false); set("shipping_street2")(e); }} />
            </Field>
          </div>
          <Field label="City" id="shipping_city">
            <Input id="shipping_city" placeholder="Pune" value={form.shipping_city} onChange={(e) => { setSameAsBilling(false); set("shipping_city")(e); }} />
          </Field>
          ...
          <Field label="Country" id="shipping_country">
            <Input id="shipping_country" placeholder="India" value={form.shipping_country} onChange={(e) => { setSameAsBilling(false); set("shipping_country")(e); }} />
          </Field>
          <Field label="Postal / ZIP Code" id="shipping_code">
            <Input id="shipping_code" placeholder="411007" value={form.shipping_code} onChange={(e) => { setSameAsBilling(false); set("shipping_code")(e); }} />
          </Field>
        </CardContent>
      </Card>
